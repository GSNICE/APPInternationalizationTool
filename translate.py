...
OUTPUT_APP_IOS = "iOS"
OUTPUT_APP_ANDROID = "Android"
OUTPUT_FORMAT_IOS = "Output/iOS"
OUTPUT_FORMAT_ANDROID = "Output/Android"
...
class SelectFileDialog(Tkinter.Frame):
    def __init__(self, root):
        ...
        options['initialfile'] = 'Internationalization.txt'  # 默认选中的文件
        ...
        root.title("National translation machine")
        ...
        cbIOS = Checkbutton(formatFrame, text=OUTPUT_APP_IOS, variable=self.value_ios)
        cbAndroid = Checkbutton(formatFrame, text=OUTPUT_APP_ANDROID, variable=self.value_android)
        # 使用网格管理器排列按钮
